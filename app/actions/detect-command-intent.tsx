...
const RESERVED_COMMANDS = [
  ...
  {
    command: "candidate plans",
    description: "Show pricing plans for candidates",
    keywords: [
      "candidate plans",
      "candidate pricing",
      "candidate subscriptions",
      "show candidate plans",
      "view candidate plans",
      "see candidate plans",
      "open candidate plans",
      "candidate plan options",
      "pricing for candidates",
      "plans for candidates",
      "what plans for candidates",
      "tell me about candidate plans",
      "explain candidate plans",
      "candidate subscription",
    ],
  },
  {
    command: "hiring manager plans",
    description: "Show pricing plans for hiring managers",
    keywords: [
      "hiring manager plans",
      "manager plans",
      "hiring manager pricing",
      "manager pricing",
      "show hiring manager plans",
      "view hiring manager plans",
      "see hiring manager plans",
      "open hiring manager plans",
      "show manager plans",
      "view manager plans",
      "see manager plans",
      "open manager plans",
      "hiring manager plan options",
      "manager plan options",
      "pricing for hiring managers",
      "pricing for managers",
      "plans for hiring managers",
      "plans for managers",
      "what plans for hiring managers",
      "what plans for managers",
      "tell me about hiring manager plans",
      "tell me about manager plans",
      "explain hiring manager plans",
